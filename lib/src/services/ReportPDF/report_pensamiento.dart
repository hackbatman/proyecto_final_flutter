...
class report_pensamiento extends StatefulWidget {
  DocumentSnapshot docid;
  String nombre;
  report_pensamiento({required this.docid, required this.nombre});
  @override
  State<report_pensamiento> createState() =>
      _reporttState(docid: docid, nombre: nombre);
}

class _reporttState extends State<report_pensamiento> {
  DocumentSnapshot docid;
  String nombre;
  ...
  void initState() {
    setState(() {
      ...
      sensaciones = widget.docid.get('sensacion_fisica');
      conducta_respuesta = widget.docid.get("conducta_respuesta");
                  ...
                  pw.Padding(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text("Ángel Rodríguez Bustamante"),
                      ],
                    ),
                  ),
                  pw.Padding(
...
//Nombre del paciente
            ...
            pw.Table(border: pw.TableBorder.all(), children: [
              pw.TableRow(
                children: [
                  ...
                  paddedHeadingTextCell('Sensacion Fisica'),
  ...
  pw.TableRow buildRowsForInventoryItems() {
    ...
    itemList.add(
      pw.Column(
        children: [
          pw.Text(sensaciones, style: pwTamanio()),
        ],
      ),
    );
    itemList.add(
      pw.Column(
        children: [
          pw.Text(conducta_respuesta, style: pwTamanio()),
        ],
      ),
    );
