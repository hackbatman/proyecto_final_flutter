...
class info_animo extends StatelessWidget {
  final String pensamiento;
  final String name_patiens;
  final String uid;

  const info_animo(this.pensamiento, this.uid, this.name_patiens, {super.key});
...
//Nombre del paciente
      ...
      Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          const Divider(),
          Text(
            'Registro de Actividades y estado de animo',
      ...
      Table(border: TableBorder.all(), children: [
        TableRow(
          children: [
            ...
            paddedHeadingTextCell('Respuestas'),
            paddedHeadingTextCell('Que cambió o que lograste?'),
          ],
        ),
              ...
              builder: (_, snapshot) {
                return ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return Column(
                        children: [
                          paddedTextCell(data['Sensaciones Fisica']),
                        ],
                      );
                    });
              }),
