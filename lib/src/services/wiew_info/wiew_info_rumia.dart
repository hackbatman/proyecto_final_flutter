...
class info_rumia extends StatelessWidget {
  final String pensamiento;
  final String name_patiens;
  final String uid;

  const info_rumia(this.pensamiento, this.uid, this.name_patiens, {super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Vista de Tabla Rumia"),
...
//Nombre del paciente
      ...
      Table(border: TableBorder.all(), children: [
        TableRow(
          children: [
            paddedHeadingTextCell('Inicio de Rumia'),
            paddedHeadingTextCell('Frases que generan malestar y activacion'),
            paddedHeadingTextCell('Temas de Rumeo'),
          ],
        ),
              ...
              builder: (_, snapshot) {
                return ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return Column(
                        children: [
                          paddedTextCell(data['inicio_rumia']),
                        ],
                      );
                    });
              }),
              ...
              builder: (_, snapshot) {
                return ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return Column(
                        children: [
                          paddedTextCell(data['malestar_activacion']),
                        ],
                      );
                    });
              }),
